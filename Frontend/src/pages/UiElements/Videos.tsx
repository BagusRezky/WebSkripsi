...
export default function Videos(): React.ReactElement {
  ...
  return (
    <>
      <PageMeta
        title={`AIDA | Billboard ${billboardName}`}
        description={`AIDA Billboard ${billboardName}`}
      />
      ...
      <div className="grid grid-cols-1 gap-5 sm:gap-6 xl:grid-cols-2">
        <div className="space-y-5 sm:space-y-6">
          <FourIsToThree billboardName={billboardName} />
        </div>
        <div className="space-y-5 sm:space-y-6">
          <ComponentCard
            title={`Perhitungan kendaraan - Billboard ${billboardName}`}
          >
